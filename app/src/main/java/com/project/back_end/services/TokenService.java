...
// The method returns the JWT token as a string.
    public String generateToken(String email) {
        ...
        Instant expiryDate = now.plusMillis(604800000L); // 7 days
        ...
        System.out.println("Generated Token: " + token); // Debugging line to print the generated token
...
// This ensures secure access control based on the user's role and their existence in the system.
    ...
    public boolean validateToken(String token, String role) {
        ...
        switch (role) {
            case "admin":
                {
                  String username = adminRepository.findByUsername(email).getUsername();
                  return username != null;
                }
            case "doctor":
                {
                    String emailInDb = doctorRepository.findByEmail(email).getEmail();
                    return emailInDb != null;
                }
            case "patient":
                {
                    String emailInDb = patientRepository.findByEmail(email).getEmail();
                    return emailInDb != null;
                }
            default:
                return false;
